...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Zé Treino locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst Zé Treino trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install Zé Treino as a full-screen app.': 'um Zé Treino als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if Zé Treino is closed.': 'Pausen-Timer-Alarm, auch wenn Zé Treino geschlossen ist.',
  ...
  'A small file a friend imports into their own Zé Treino — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes Zé Treino importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'this isn’t an Zé Treino plan file': 'das ist keine Zé Treino-Plandatei',
  'Shared routine': 'Geteilte Routine',
  'Unknown exercise': 'Unbekannte Übung',
  'Weekly Training Plan': 'Wochen-Trainingsplan',
  'Made with Zé Treino': 'Erstellt mit Zé Treino',
  ...
  'Reload Zé Treino': 'Zé Treino neu laden',
