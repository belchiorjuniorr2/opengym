...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Zé Treino locally on this device.": 'Этот браузер не поддерживает ключи доступа — но Zé Treino можно использовать локально на этом устройстве.',
  ...
  'to install Zé Treino as a full-screen app.': 'чтобы установить Zé Treino как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if Zé Treino is closed.': 'Оповещения таймера отдыха, даже если Zé Treino закрыт.',
  ...
  'A small file a friend imports into their own Zé Treino — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Zé Treino — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload Zé Treino': 'Перезагрузить Zé Treino',
