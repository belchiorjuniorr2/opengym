...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Zé Treino locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de Zé Treino’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install Zé Treino as a full-screen app.': 'ile Zé Treino’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if Zé Treino is closed.': 'Zé Treino kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own Zé Treino — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Zé Treino\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
