...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Zé Treino locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar Zé Treino localmente en este dispositivo.',
  ...
  'to install Zé Treino as a full-screen app.': 'para instalar Zé Treino como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if Zé Treino is closed.': 'Avisos del temporizador de descanso, incluso con Zé Treino cerrado.',
  ...
  'A small file a friend imports into their own Zé Treino — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio Zé Treino: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload Zé Treino': 'Recargar Zé Treino',
